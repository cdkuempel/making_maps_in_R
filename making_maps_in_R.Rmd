...
ggplot() +
  ...
  #geom_sf(data = labels, size = 1) +
  #geom_text_repel(data = labels, aes(x = lng, y = lat, label = label))
  #geom_sf_label(data = labels, aes(label = label))
...
tm_shape(pop_shp) + 
  tm_polygons("persons", size = "persons") +
